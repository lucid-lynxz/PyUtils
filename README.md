...
pip3 install airtest pocoui psutil cnocr zstd pillow pyperclip pandas pydantic schedule longport akshare pandas openpyxl pyautogui Crypto wmi pillow pywin32 paramiko onnxruntime -i https://pypi.tuna.tsinghua.edu.cn/simple
```
