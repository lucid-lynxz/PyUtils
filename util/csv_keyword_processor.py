...
class CSVKeywordProcessor:
    def __init__(self, keyword_mapping: Optional[Dict[str, str]] = None,
                 secondary_processing_rules: Optional[Dict[str, list]] = None,
                 join_separator: str = '-'):
        """
        初始化CSV关键字处理器
        ...
        # 二次处理规则
        self.secondary_processing_rules = secondary_processing_rules or {}
...
def main(keyword_mapping: dict,  # 映射关系
    ...
    processor = CSVKeywordProcessor(keyword_mapping, secondary_processing_rules, join_separator)
